...
class LotteryCog(commands.Cog):
    ...
    @lottery.command(name="buy", description="Buy Lottery tickets with a chosen number.")
    ...
    @lottery.command(name="random", description="Buy Lottery tickets with random numbers.")
    ...
    @lottery.command(name="tickets", description="View your current Lottery tickets.")
    ...
    @lottery.command(name="info", description="View current Lottery draw info.")
    ...
    @lottery.command(name="set-channel", description="Set Lottery announcement channel.")
    ...
    @commands.group(name="lt", aliases=["lottery"], invoke_without_command=True)
    async def prefix_lottery(self, ctx: commands.Context) -> None:
        service = self.bot.lottery_service  # type: ignore[attr-defined]
        state = await service.get_state()
        await ctx.reply(embed=render_announcement_embed(state), mention_author=False)
    ...
    async def prefix_tickets(self, ctx: commands.Context) -> None:
        ...
        await ctx.reply(embed=render_user_tickets_embed(state, tickets, ctx.author), mention_author=False)
    ...
    @prefix_lottery.command(name="set-channel")
    ...
    async def prefix_set_channel(self, ctx: commands.Context, channel: discord.TextChannel) -> None:
        ...
        await ctx.reply(f"Lottery announcement channel set to {channel.mention}.", mention_author=False)
    ...
    async def _handle_prefix_buy(self, ctx: commands.Context, number: str, quantity: int) -> None:
        ...
        try:
            ...
            return
        await ctx.reply(_purchase_message(result), mention_author=False)
