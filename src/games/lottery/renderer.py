...
def render_announcement_embed(state: LotteryState, bot_name: str | None = None) -> discord.Embed:
    embed = discord.Embed(
...
def render_purchase_embed(result: LotteryPurchaseResult, player: discord.abc.User, bot_name: str | None = None) -> discord.Embed:
...
def render_user_tickets_embed(state: LotteryState, tickets: list[LotteryTicket], player: discord.abc.User, bot_name: str | None = None) -> discord.Embed:
    embed = discord.Embed(color=discord.Color.gold())
    embed.set_author(name=f"{player.display_name}'s Lottery Tickets", icon_url=player.display_avatar.url)
...
def render_draw_result_embed(result: LotteryDrawResult, bot_name: str | None = None) -> discord.Embed:
    embed = discord.Embed(color=discord.Color.gold())
